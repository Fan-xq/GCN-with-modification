...
import pandas as pd
import sys
#sys.path.append('/Users/fanxiaoqing/Downloads/RBS-master')
...
def load_dataset1(features, G, labels):
    ...
    Y = RBS.RBS_matrix(G,10, 0.9)
    Y[Y>1]=1
    graph1 = nx.Graph(Y)
    G_RMST = RMST.RMST(graph1, gamma = 0.5, weighted = False)
    adj = nx.adjacency_matrix(G_RMST)
