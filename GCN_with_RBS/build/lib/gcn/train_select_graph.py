...
file.write("Sparsity_parameter" + ',' + "id" + ',' + "Epoches_stopped" + ','+ 'Train_accuracy' + ','+ 'Validation_accuracy' + ',' + 'Density'+ ',' + 'Time(second)' + '\n')
...
for iii in sparsity_parameter_list:
    for jjj in id_file:
        ...
        file.write(str(iii) + ',' + str(jjj) + ','  + str(epoch+1)+ ',' + str(outs[2]) + ',' + str(acc)+ ',' + str(density) + ',' + str(round(time.time() - t0,4)) + '\n')
        file.close()
    # break
