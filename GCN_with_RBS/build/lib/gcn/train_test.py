...
if Path('performance_{}_{}_test.csv'.format(FLAGS.dataset,FLAGS.case)).is_file():
    os.remove('performance_{}_{}_test.csv'.format(FLAGS.dataset,FLAGS.case))

file = open('performance_{}_{}_test.csv'.format(FLAGS.dataset,FLAGS.case),'w')
...
for iii in [7]:
    for jjj in id_file:
        ...
        file = open('performance_{}_{}_test.csv'.format(FLAGS.dataset,FLAGS.case),'a')
