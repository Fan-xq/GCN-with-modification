...
flags.DEFINE_string('case', 'no_graph', 'Case string.')  # 'org','random_graph','random_features','random_both','no_features','no_graph','complete_graph'
...
def load_data_keras(dataset,case):
    ...
    # No graph
    adj = sp.coo_matrix(np.zeros((features.shape[0],features.shape[0])))
    edges = 0
