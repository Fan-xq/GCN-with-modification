...
def load_data_keras(dataset,case,p_random,id_file):
    ...
    # edges_unordered = np.genfromtxt("data/cora/input/{}.cites".format(dataset), dtype=np.int32)
    edges_unordered = np.genfromtxt("data/{}/{}_{}/input/{}_org_random{}Percent_{}.cites".format(dataset,dataset,case,dataset,p_random,id_file), dtype=np.int32)
