...
def load_data_keras(dataset,case,knn_k):
    ...
    edges_unordered = np.genfromtxt("data/{}/{}_{}/input/{}_{}_k_{}.cites".format(dataset,dataset,case,dataset,case,knn_k), dtype=np.int32)
...
knn_k_list = range(1,11,1)
id_file = list(range(1,6,1))

for iii in knn_k_list:
    for jjj in id_file:
        print("Current knn_k is {}".format(iii),"Current Id is {}".format(jjj))
        t0 = time.time()
