...
def load_data_keras(dataset,case,cknn_delta):
    ...
    edges_unordered = np.genfromtxt("data/{}/{}_{}/input/{}_{}_delta_{}_k_1.cites".format(dataset,dataset,case,dataset,case,cknn_delta), dtype=np.int32)
...
cknn_delta_list = np.arange(1.4,1.5,0.1)
id_file = list(range(1,6,1))

for iii in cknn_delta_list:
    for jjj in id_file:
        print("Current cknn_delta is {}".format(iii),"Current Id is {}".format(jjj))
        t0 = time.time()
