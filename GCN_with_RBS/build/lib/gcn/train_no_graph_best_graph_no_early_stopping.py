...
if Path('performance_{}_{}_best_graph_no_early_stopping.csv'.format(FLAGS.dataset,FLAGS.case)).is_file():
    os.remove('performance_{}_{}_best_graph_no_early_stopping.csv'.format(FLAGS.dataset,FLAGS.case))

file = open('performance_{}_{}_best_graph_no_early_stopping.csv'.format(FLAGS.dataset,FLAGS.case),'w')
file.write("id" + ',' + "Epoches_stopped" + ','+ 'Test_accuracy' + ',' + 'Density'+ ',' + 'Time(second)' + '\n')
...
for jjj in id_file:
    ...
    file = open('performance_{}_{}_best_graph_no_early_stopping.csv'.format(FLAGS.dataset,FLAGS.case),'a')
    file.write(str(jjj) + ','  + str(epoch+1) + ',' + str(test_acc) + ',' + str(density) + ',' + str(round(time.time() - t0,4)) + '\n')
    file.close()
