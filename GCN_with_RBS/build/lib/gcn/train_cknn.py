...
def load_data_keras(dataset,case,cknn_k):
    ...
    edges_unordered = np.genfromtxt("data/{}/{}_{}/input/{}_{}_delta_1_k_{}.cites".format(dataset,dataset,case,dataset,case,cknn_k), dtype=np.int32)
...
cknn_k_list = range(10,110,10)
id_file = list(range(1,6,1))

for iii in cknn_k_list:
    for jjj in id_file:
        print("Current cknn_k is {}".format(iii),"Current Id is {}".format(jjj))
        t0 = time.time()
