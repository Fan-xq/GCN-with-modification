...
flags.DEFINE_string('case', 'random_features', 'Case string.')  # 'org','random_graph','random_features','random_both','no_features','no_graph','complete_graph'
...
def load_data_keras(dataset,case,p_random,id_file):
    ...
    idx_features_labels = np.genfromtxt("data/{}/{}_{}/input/{}_randomFeature{}Percent_{}.content".format(dataset,dataset,case,dataset,p_random,id_file), dtype=np.dtype(str))
    ...
    edges_unordered = np.genfromtxt("data/{}/{}_{}/input/{}.cites".format(dataset,dataset,case,dataset), dtype=np.int32)
