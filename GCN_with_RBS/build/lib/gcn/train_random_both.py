...
file.write("randomized percentage wanted" + ',' + "id" + ',' + "Epoches stopped" + ',' + 'Accuracy' + ',' +'Time(second)' + '\n')
...
def load_data_keras(dataset,case,p_random,id_file):
    ...
    idx_features_labels = np.genfromtxt("data/{}/{}_random_features/input/{}_randomFeature{}Percent_{}.content".format(dataset,dataset,dataset,p_random,id_file), dtype=np.dtype(str))
    ...
    edges_unordered = np.genfromtxt("data/{}/{}_random_graph/input/{}_random{}Percent_{}.cites".format(dataset,dataset,dataset,p_random,id_file), dtype=np.int32)
...
def get_splits(y):
    if FLAGS.dataset == "constructive":
        idx_train = range(50)
        idx_val = range(50, 150)
        idx_test = range(150, 1000)
    elif FLAGS.dataset == "cora":
        idx_train = range(119)
        idx_val = range(119, 367)
        idx_test = range(367, 2485)
    elif FLAGS.dataset == "aminer":
        idx_train = range(98)
        idx_val = range(98, 310)
        idx_test = range(310, 2072)
    elif FLAGS.dataset == "wikipedia":
        idx_train = range(720)
        idx_val = range(720, 3078)
        idx_test = range(3078, 20525)
    elif FLAGS.dataset == "wikipedia1":
        idx_train = range(120)
        idx_val = range(120, 362)
        idx_test = range(278, 2414)
    elif FLAGS.dataset == "wikipedia2":
        idx_train = range(90)
        idx_val = range(90, 278)
        idx_test = range(278, 1858)
...
for iii in p_random:
    for jjj in id_file:
        ...
        df.to_csv('data/{}/{}_{}/output/performance_{}_output_{}_{}_id_{}.csv'.format(FLAGS.dataset,FLAGS.dataset,FLAGS.case,FLAGS.dataset,FLAGS.case,iii,jjj),index=True,sep=',')
