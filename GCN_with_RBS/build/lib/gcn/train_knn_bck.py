...
flags.DEFINE_string('case', 'org', 'Case string.')  # 'org','random_graph','random_features','random_both','no_features','no_graph','complete_graph'
...
for k_degree in range(10,110,10):
    for k_degree in range(10,110,10):
    ...
    adj = kneighbors_graph(features.toarray(), iii, mode='connectivity', include_self=False)
