...
flags.DEFINE_integer('num_randomization', 'org', 'Number of randomizations.')
flags.DEFINE_integer('idx_train', 50, 'Index for training set'.)
flags.DEFINE_integer('idx_val', 150, 'Index for validation set'.)
flags.DEFINE_integer('idx_test', 1000, 'Index for test set'.)
...
def get_splits(y):
    idx_train = range(FLAGS.idx_train)
    idx_val = range(FLAGS.idx_train, FLAGS.idx_val)
    idx_test = range(FLAGS.idx_val, FLAGS.idx_test)
